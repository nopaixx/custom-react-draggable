...
import CADTDraggableCore from './DraggableCore';
import type {
	ControlPosition,
...
class CADTDraggable extends React.Component<DraggableProps, DraggableState> {
...
export { CADTDraggable as default, CADTDraggableCore };
